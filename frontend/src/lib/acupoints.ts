...
export const POINTS: Point[] = [
  ...
  { id: "GB34", name: "陽陵泉", py: "Yánglíngquán", meridian: "足少陽膽經", view: "front", x: 242, y: 448, location: "膝下，腓骨頭前下方凹陷。", action: "疏肝利膽、舒筋活絡。", indications: "膝痛、坐骨神經痛、肝膽疾患、抽筋。", special: "膽經合穴 · 八會穴之筋會" },
  { id: "ST36", name: "足三里", py: "Zúsānlǐ", meridian: "足陽明胃經", view: "front", x: 180, y: 453, location: "膝下三寸，脛骨前緣外一橫指。", action: "健脾和胃、補中益氣、扶正培元。", indications: "胃痛、消化不良、疲勞、養生保健第一要穴。", special: "胃經合穴 · 四總穴(肚腹)" },
  ...
  { id: "BL40", name: "委中", py: "Wěizhōng", meridian: "足太陽膀胱經", view: "back", x: 170, y: 408, location: "膕橫紋中點。", action: "舒筋活絡、清熱涼血。", indications: "腰背痛、膝關節痛、下肢痿軟。", special: "膀胱經合穴 · 四總穴(腰背)" },
