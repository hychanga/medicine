...
export const POINTS: Point[] = [
  ...
  { id: "GB34", name: "陽陵泉", py: "Yánglíngquán", meridian: "足少陽膽經", view: "front", x: 242, y: 448, location: "膝下，腓骨頭前下方凹陷。", action: "疏肝利膽、舒筋活絡。", indications: "膝痛、坐骨神經痛、肝膽疾患、抽筋。", special: "膽經合穴 · 八會穴之筋會 · 膽之下合穴" },
  { id: "ST36", name: "足三里", py: "Zúsānlǐ", meridian: "足陽明胃經", view: "front", x: 180, y: 453, location: "膝下三寸，脛骨前緣外一橫指。", action: "健脾和胃、補中益氣、扶正培元。", indications: "胃痛、消化不良、疲勞、養生保健第一要穴。", special: "胃經合穴 · 四總穴(肚腹) · 胃之下合穴" },
  { id: "SP9", name: "陰陵泉", py: "Yīnlíngquán", meridian: "足太陰脾經", view: "front", x: 187, y: 456, location: "小腿內側，脛骨內側髁後下方凹陷。", action: "健脾利水、消腫。", indications: "水腫、小便不利、膝痛、腹脹。", special: "脾經合穴" },
  { id: "SP6", name: "三陰交", py: "Sānyīnjiāo", meridian: "足太陰脾經", view: "front", x: 181, y: 525, location: "內踝尖上三寸，脛骨內側緣後方。", action: "健脾益血、調補肝腎、安神。", indications: "月經不調、痛經、失眠、下肢水腫（孕婦禁針）。", genderNote: "婦科要穴，但孕婦禁針、禁強刺激：易引發子宮收縮、動胎氣，懷孕期間務必避免。", special: "足三陰經交會穴" },
  { id: "KI3", name: "太溪", py: "Tàixī", meridian: "足少陰腎經", view: "front", x: 185, y: 545, location: "內踝尖與跟腱之間凹陷處。", action: "滋補腎陰、培補元氣。", indications: "腰痛、耳鳴、失眠、足跟痛。", special: "腎經原穴 · 輸穴" },
  { id: "KI6", name: "照海", py: "Zhàohǎi", meridian: "足少陰腎經", view: "front", x: 185, y: 553, location: "內踝尖下方凹陷處。", action: "滋陰清熱、調補沖任。", indications: "咽喉乾痛、失眠、月經不調。", special: "八脈交會(通陰蹺脈)" },
  { id: "GB39", name: "懸鐘", py: "Xuánzhōng", meridian: "足少陽膽經", view: "front", x: 230, y: 535, location: "外踝尖上三寸，腓骨前緣。", action: "疏肝益腎、舒筋活絡。", indications: "頸項強痛、踝關節痛、下肢痿軟。", special: "八會穴之髓會" },
  { id: "SP3", name: "太白", py: "Tàibái", meridian: "足太陰脾經", view: "front", x: 176, y: 572, location: "足內側緣，第一蹠骨關節後下方凹陷。", action: "健脾化濕、理氣和胃。", indications: "腹脹、腹瀉、胃痛、體倦乏力。", special: "脾經原穴 · 輸穴" },
  { id: "ST44", name: "內庭", py: "Nèitíng", meridian: "足陽明胃經", view: "front", x: 196, y: 578, location: "足背第二、三趾間縫紋端。", action: "清胃瀉火、理氣止痛。", indications: "牙痛、咽喉腫痛、胃痛、足背腫痛。", special: "胃經滎穴" },
  { id: "LR3", name: "太衝", py: "Tàichōng", meridian: "足厥陰肝經", view: "front", x: 190, y: 572, location: "足背，第一、二蹠骨結合部前方凹陷。", action: "平肝熄風、疏肝理氣、清熱明目。", indications: "頭痛、眩暈、情緒煩躁、高血壓。", special: "肝經原穴 · 輸穴" },
  ...
  { id: "ST34", name: "梁丘", py: "Liángqiū", meridian: "足陽明胃經", view: "front", x: 188, y: 428, location: "髕骨外上緣上二寸。", action: "和胃止痛、舒筋活絡。", indications: "急性胃痛、膝關節腫痛、乳癰。", special: "胃經郄穴" },
  ...
  { id: "ST40", name: "豐隆", py: "Fēnglóng", meridian: "足陽明胃經", view: "front", x: 198, y: 492, location: "外踝尖上八寸，脛骨前緣外二橫指。", action: "和胃氣、化痰濕。", indications: "咳嗽痰多、頭痛、眩暈、下肢腫痛。", special: "胃經絡穴" },
  ...
  { id: "SP4", name: "公孫", py: "Gōngsūn", meridian: "足太陰脾經", view: "front", x: 172, y: 580, location: "足內側緣，第一蹠骨基底前下方赤白肉際。", action: "健脾和胃、通調沖脈。", indications: "胃痛、嘔吐、腹脹、腹瀉、心煩。", special: "脾經絡穴 · 八脈交會(通沖脈)" },
  ...
  { id: "SI1", name: "少澤", py: "Shàozé", meridian: "手太陽小腸經", view: "front", x: 122, y: 322, location: "小指尺側指甲角旁0.1寸。", action: "清熱通乳、開竅利咽。", indications: "乳少、乳癰、咽喉腫痛、熱病昏迷。", special: "小腸經井穴" },
  ...
  { id: "ST42", name: "衝陽", py: "Chōngyáng", meridian: "足陽明胃經", view: "front", x: 196, y: 566, location: "足背最高處，動脈搏動處。", action: "和胃化痰、通絡寧神。", indications: "胃痛、腹脹、足背腫痛、面腫。", special: "胃經原穴" },
  { id: "ST45", name: "厲兌", py: "Lìduì", meridian: "足陽明胃經", view: "front", x: 201, y: 588, location: "第二趾外側趾甲角旁0.1寸。", action: "清胃瀉熱、寧神醒腦。", indications: "牙痛、咽喉腫痛、多夢、熱病、足背痛。", special: "胃經井穴" },
  { id: "SP1", name: "隱白", py: "Yǐnbái", meridian: "足太陰脾經", view: "front", x: 178, y: 586, location: "大趾內側趾甲角旁0.1寸。", action: "健脾統血、寧神定志。", indications: "月經過多、崩漏、腹脹、多夢、驚風。", special: "脾經井穴" },
  { id: "LR1", name: "大敦", py: "Dàdūn", meridian: "足厥陰肝經", view: "front", x: 188, y: 588, location: "大趾外側趾甲角旁0.1寸。", action: "疏肝理氣、調經止血。", indications: "疝氣、遺尿、月經不調、崩漏、癲癇。", special: "肝經井穴" },
  { id: "GB44", name: "足竅陰", py: "Zúqiàoyīn", meridian: "足少陽膽經", view: "front", x: 207, y: 584, location: "第四趾外側趾甲角旁0.1寸。", action: "清肝瀉熱、通竅聰耳。", indications: "偏頭痛、耳鳴耳聾、目赤、脅痛、多夢。", special: "膽經井穴" },
  ...
  { id: "SP8", name: "地機", py: "Dìjī", meridian: "足太陰脾經", view: "front", x: 185, y: 480, location: "陰陵泉下三寸，脛骨內側緣後方。", action: "健脾滲濕、調經止帶。", indications: "痛經、月經不調、腹痛腹瀉、水腫、小便不利。", special: "脾經郄穴" },
  { id: "KI9", name: "築賓", py: "Zhùbīn", meridian: "足少陰腎經", view: "front", x: 188, y: 505, location: "太溪上五寸，腓腸肌內側肌腹下方。", action: "調補肝腎、清熱寧神。", indications: "癲狂、嘔吐涎沫、疝氣、小腿內側痛。", special: "陰維脈郄穴" },
  { id: "LR6", name: "中都", py: "Zhōngdū", meridian: "足厥陰肝經", view: "front", x: 183, y: 508, location: "內踝尖上七寸，脛骨內側面中央。", action: "疏肝理氣、調經止血。", indications: "脅痛、腹痛、崩漏、惡露不盡、疝氣。", special: "肝經郄穴" },
  { id: "LR5", name: "蠡溝", py: "Lígōu", meridian: "足厥陰肝經", view: "front", x: 182, y: 516, location: "內踝尖上五寸，脛骨內側面中央。", action: "疏肝理氣、調經利濕。", indications: "月經不調、帶下、小便不利、疝氣、外陰瘙癢。", special: "肝經絡穴" },
  { id: "KI8", name: "交信", py: "Jiāoxìn", meridian: "足少陰腎經", view: "front", x: 189, y: 531, location: "太溪上二寸，復溜前方，脛骨內側緣後方。", action: "調經止血、利水通淋。", indications: "月經不調、崩漏、泄瀉、便秘、睪丸腫痛。", special: "陰蹺脈郄穴" },
  { id: "KI4", name: "大鐘", py: "Dàzhōng", meridian: "足少陰腎經", view: "front", x: 189, y: 548, location: "太溪下方稍後，跟腱內側緣前方凹陷。", action: "益腎調氣、強腰利水。", indications: "咳血、氣喘、腰脊強痛、小便不利、癡呆。", special: "腎經絡穴" },
  { id: "KI5", name: "水泉", py: "Shuǐquán", meridian: "足少陰腎經", view: "front", x: 187, y: 551, location: "太溪直下一寸，跟骨結節內側凹陷。", action: "清熱益腎、通經活血。", indications: "月經不調、痛經、小便不利、目昏花。", special: "腎經郄穴" },
  { id: "GB36", name: "外丘", py: "Wàiqiū", meridian: "足少陽膽經", view: "front", x: 236, y: 508, location: "外踝尖上七寸，腓骨前緣。", action: "疏肝理氣、舒筋活絡。", indications: "頸項痛、胸脅痛、下肢痿痺、癲狂。", special: "膽經郄穴" },
  { id: "GB35", name: "陽交", py: "Yángjiāo", meridian: "足少陽膽經", view: "front", x: 240, y: 510, location: "外踝尖上七寸，腓骨後緣。", action: "舒肝理氣、寧神定志。", indications: "胸脅脹滿、下肢痿痺、癲狂、面腫。", special: "陽維脈郄穴" },
